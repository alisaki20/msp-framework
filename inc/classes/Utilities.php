...
class Utilities {
     ...
     *
     * @param $dir the directory to get its url. use __DIR__ variable should be enough
     * @return string|void
     */
    public static function get_dir_url($dir ) {
		return site_url( str_replace(
			trailingslashit( str_replace( '\\', '/', ABSPATH ) ),
			'',
			self::get_dir_path( $dir )
		) );
	}

    /**
     * @param $dir directory to get its path. use __DIR__ variable should be enough
     * @return string
     */
